...
TEST_PARAMETERS: List[Tuple[str, int]] = [
    # -2
    ('C-2', 0),
    ('C#-2', 1),
    ('D-2', 2),
...
class TestNoteConverter:  # noqa: D101
    ...
    @pytest.mark.parametrize('note, expected_decimal', TEST_PARAMETERS)
    ...
    def test_decimal_to_note(self, expected_note: str, decimal: int) -> None:
